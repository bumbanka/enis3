...
const CITIES = [
  ...
  { code: "aktau", name: "Актау" },
  { code: "kostanay", name: "Костанай" },
  { code: "petropavlovsk", name: "Петропавловск" },
  { code: "semey", name: "Семей" },
  { code: "taldykorgan", name: "Талдыкорган" },
  { code: "kokshetau", name: "Кокшетау" },
